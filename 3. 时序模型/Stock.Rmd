...
for (company in company_list) {
  ...
  # 使用最佳模型对测试集进行预测
  forecasted_values <- forecast(best_model, h = length(test_set))
  # 计算最佳模型的性能指标
  ...
  print(paste("Best model for", company, ": ARIMA", 
              paste(best_pdq, collapse = ","), 
              "AIC:", best_model_aic))
  print(model_metrics)
  print(paste("Ljung-Box Test p-value:", lb_test$p.value))
}
